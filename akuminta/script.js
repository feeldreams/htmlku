var teksSekarang = 1;const body = document.querySelector("body"); audio = new Audio('' + linkmp3.src); 
    ...
    varteks = teks2.innerHTML; teks2.innerHTML = "";
    function katanimasi(){
	  new TypeIt("#teks2", {
      strings: ["" + varteks], startDelay: 250, speed: 38, cursor: true,
      afterComplete: function(){
      	clearInterval(scrollInterval);
      	teks2.innerHTML = varteks;
      	setInterval(berjatuhan, 200);
          stiker2.style = "transform:scale(0);opacity:0;transition:all .8s ease;margin-top:180px";
          setTimeout(function(){
          	stiker2a.src = stiker2b.src;
          	stiker2.style = "transition:all .8s ease;margin-top:180px";
          },300);
      },}).go();
}
