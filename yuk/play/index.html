...
<head>
    ...
    <meta property="og:title" content="Sesuatu Untukmu ✨">
    <meta property="og:description" content="Kamu Mau Ga... 🫂">
    ...
    <meta property="og:url" content="Htmlku.com/mau">
    ...
    <script src="https://unpkg.com/typeit@8.7.0/dist/index.umd.js"></script><link rel="stylesheet" href="style.css">
...
<style>
    ...
    .textLeft{display:flex;width:100%;height: 180px; overflow: auto;justify-content: left;text-align: left !important;margin-left:70px;}
    ...
    .stiker img{width:90px;height:90px;box-shadow: 0 4px 30px rgba(255,255,255, 0.3);backdrop-filter: blur(5px);-webkit-backdrop-filter: blur(5px);background: rgba(255, 255, 255, .5);border: 1px solid rgba(255, 255, 255, 0.3);border-radius: 50%;padding:10px;}
    ...
    .overlay {position: fixed;top: 0;left: 0;width: 100%;height: 100%;display: flex;flex-direction:column;justify-content: center;align-items: center;background:rgba(0,0,0,.6);z-index:100;}
    ...
    .blocktext{margin-top:10px;position:relative;width:100%;height: 180px; overflow: auto;background-color:none;}
    
    .sertifikat {position: relative;width: 330px;height: 236px;text-shadow:none}
	.sertifikat img {border-radius:30px;width: 100%;height: 100%;}
	.text-overlay {position: absolute;top: 35px;left: 0;width: 100%;text-align: center;color: #333;font-size: 14px;font-weight: bold;}
	.text-overlay h1 {font-size: 20px;color:#fff;margin: 0;}
	.text-overlay .sub-title {font-size: 14px;color:yellow;margin-bottom: 10px;}
	.content {font-size: 12px;color:#fff;}
	.real {font-weight: bold;color: #fff;font-size: 12px;}
    ...
    .swal2-timer-progress-bar-container > *{opacity:.6;background:#00B6FF;margin:0 14px}
    .swal2-modal{box-shadow: rgba(255,255,255, 0.3) 0px 7px 29px 0px;background:rgba(0,0,0,.9);max-width:320px;border-right:2px solid #fff;border:2px solid #fff;border-radius:20px;top:-50px;}
    ...
    .swal2-styled.swal2-confirm, .swal2-styled.swal2-cancel{position: relative;background-color: #4839eb;color: #fff;border-radius:20px;z-index: 1;transition: all 0.2s;}
    .swal2-container.swal2-backdrop-show {
    background: transparent;
    }
	
    .cover{margin-top:-120px;display:flex;flex-direction:column;justify-content:center;align-items:center}
    ...
    .awalan{margin-top:20px;width:220px;min-height:25px;padding:12px;font-size:13px;color:white;background:rgba(0,0,0,.5);border:1px solid #fff;border-radius:50px;display:flex;align-items:center;text-align:left}
    .awalan svg{margin-right:15px;width:25px;height:25px;stroke:white}
    
	.mainMsg{margin:auto;width:270px;min-height:240px;background:rgba(0,0,0,.5);backdrop-filter:blur(3px);-webkit-backdrop-filter:blur(3px);border: 2px solid white;border-radius:20px;padding:20px;margin-top:120px;display:flex;flex-direction:column;justify-content:flex-start;align-items:center;z-index:999;transform:scale(0);transition:all 0.7s ease;}
	.mainSt{display:flex;justify-content:center;align-items:center;margin-left:auto;margin-right:auto;transform:scale(0);transition:all 0.7s ease;}
	.mainSt img{width:80px;height:80px;box-shadow:0 4px 30px rgba(255,255,255,0.3);backdrop-filter:blur(5px);-webkit-backdrop-filter:blur(5px);background:rgba(255,255,255,0.4);border:2px solid rgba(255,255,255,0.3);border-radius:50%;padding:10px;}
	.mainTxt, .secondTxt{margin-top:24px;text-align:center;color:white;font-size:18px;font-weight:700;transform:scale(0);transition:all 0.7s ease;}
	#teksMacet, #teksTime{transition:all 0.7s ease;}
	.txtAlt{font-size:17px;font-weight:400;}
	.txtAltLv{font-family: 'Caveat', cursive;font-size:21px;font-weight:700;line-height:1.5em}
    .secondTxt{margin-top:12px;transform:scale(0);transition:all 0.7s ease;}
    .txtWaktu, .txtKemunculan{font-size:17px;font-weight:400;opacity:0;transition:all 0.7s ease;}
    .txtKemunculan{font-size:18px;font-weight:400;}

	#Tombol {margin-top:24px;position: absolute;transform:scale(0);opacity:0;margin-left:auto;margin-right:auto;display:flex;justify-content:center;align-items:center;list-style:none;transition:all .7s ease;}
    #Tombol a {cursor:none;display:inline-flex;justify-content:center;align-items:center;margin:0 8px;min-width:40px;padding:10px;outline:0;border:2px solid white;border-radius:20px;line-height:15px;background:rgba(0,0,0,.5);color:white;font-size:15px;font-weight:700;white-space:nowrap;overflow:hidden;box-shadow: rgba(255,255,255, 0.15) 0px 7px 29px 0px;z-index:1;transition:all .7s ease;}
    #Tombol a.biru{background:#3D3BF3}
    #Tombol a.merah{background:#FF2929}
    
    #container{width:80%;margin:20px auto;min-height:650px;margin-top:150px;color:#000}@media screen and (max-width:400px){#container{width:100%;margin:50% auto;min-height:800px}}.wrapper{position:fixed}.box div{position:fixed;width:60px;height:60px;background-color:transparent;border:6px solid rgba(255,255,255,.6);border-radius:50%;z-index:-10}.box div:nth-child(1){top:12%;left:42%;animation:animate 10s linear infinite}.box div:nth-child(2){top:70%;left:50%;animation:animate 7s linear infinite}.box div:nth-child(3){top:17%;left:6%;animation:animate 9s linear infinite}.box div:nth-child(4){top:20%;left:60%;animation:animate 10s linear infinite}.box div:nth-child(5){top:67%;left:10%;animation:animate 6s linear infinite}.box div:nth-child(6){top:80%;left:70%;animation:animate 12s linear infinite}.box div:nth-child(7){top:60%;left:80%;animation:animate 15s linear infinite}.box div:nth-child(8){top:32%;left:25%;animation:animate 16s linear infinite}.box div:nth-child(9){top:90%;left:25%;animation:animate 9s linear infinite}.box div:nth-child(10){top:20%;left:80%;animation:animate 5s linear infinite}@keyframes animate{0%{transform:scale(0) translateY(0) rotate(0);opacity:.8}100%{transform:scale(1.3) translateY(-90px) rotate(360deg);opacity:0}}
    
    /* Tambahkan animasi klik */
	.click-effect {position: fixed;width: 8px;height: 8px;border-radius: 50%;background: rgba(255, 255, 255, 0.8);pointer-events: none;transform: translate(-50%, -50%) scale(1);animation: click-animation 0.3s ease-out forwards;z-index: 9999;}
	/* Animasi menghilang */
	@keyframes click-animation {0% {transform: translate(-50%, -50%) scale(1);opacity: 1;} 100% {transform: translate(-50%, -50%) scale(2);opacity: 0;}}
</style>
<body>
    <audio src="https://feeldreams.github.io/audio/angelbabydj.mp3" id="linkmp3" class="sembunyi"></audio>
    <div class="overlay">
        <div class="cover">
            <p style="font-size:17px;font-weight:700;margin:0">Buka ini bentar yaa 🥳</p>
            <div id="loveIn" class="awalan">
                ...
                <label style="font-size:16px">Htmlku.com/yuk</label>
            </div>
        </div>
    </div>

    <div id="bodyblur">
        <img src="https://i.ibb.co.com/X7DT560/f1d6e11838b8bcd7e2dc683e0379fe18.jpg" id="wallpaper" />
    </div>
    ...
    <div class="swiper">
        ...
        <div class="mainMsg">
            <div class="mainSt">
                <img id="st1" src="https://htmlku.com/0/panda/terlope.gif" />
                <img id="st2" src="https://htmlku.com/0/panda/cilukba.gif" class="sembunyi" />
                <img id="st3" src="https://htmlku.com/0/panda/hearthappy.gif" class="sembunyi" />
                <img id="st4" src="https://htmlku.com/0/panda/ledekin.gif" class="sembunyi" />
                <img id="st5" src="https://htmlku.com/0/panda/muah.gif" class="sembunyi" />
            </div>
            <span class="mainTxt"></span>
        </div>
        
        <div id="Tombol">
                <a id="By" class="biru" onClick="fnYes()">Bolehh</a>
                <a id="Bn" class="merah" onClick="btn='Bn';fungsibaru(btn)">Ga deh</a>
            </div>

            <div class="sembunyi">
                <span id="teksGamau" class="sembunyi">Harus terima yaa 😜</span>
                <img id="stikerGamau" src="https://htmlku.com/0/panda/teriak.gif" class="sembunyi" />
            </div>
        ...
        <script>
            ...
            const texts = [
                "<b style='font-size:20px'>Alooo Mantankuu.. 😆</b><br><br><span class='txtAlt'>Yang ke: <b id='angka' style'font-size:24px !important'></b></span><span class='txtWaktu'></span>",
                "<b style='font-size:20px'>Alooo Mantankuu.. 😆</b><br><br><span class='txtAlt'>Yang tersayanggg, termanisss,<br>terlucuu, tercakep seduniaaa 🫣</span><span class='txtKemunculan'></span>",
                "<b style='font-size:20px'>Yeaayyyy! 😋💗</b><br><br><span class='txtAlt' style='line-height:1.5em'>Tapi... dalam waktu <b style='color:yellow;'>5</b> detik,<br>Kita <b>PUTUS</b> lagi yaaa 🥹</span><br><br><span id='teksTime' ><b style='font-size:20px'>⏳&nbsp;<span id='timerLeft'>5</span></b></span>",
                "<b style='font-size:20px'>Tapi Boongg! 😜</b><br><br><span class='txtAlt' style='line-height:1.5em'>Mulai sekarang, kita<br>beneran <b>balikan</b> yaa 🥳</span><br><br><span class='txtAltLv'>I Love Youuuu 🫣💐💗</span>",
            ];
            ...
            function nextSection() {
                ...
                setTimeout(() => {
                    ...
                    /*if (currentIndex == 1) {
                        ...
                        setTimeout(() => { teksAnimasi(texts[currentIndex]) }, 200);
                    }*/
                    if (currentIndex == 2) {
                        tombol.style = "";
                    }
                    ...
                    if (currentIndex < 3 && currentIndex != 1 && currentIndex != 2) {
                        mainSt.querySelector('img').src = images[currentIndex];
    ...
    <script>
        document.addEventListener("click", function (e) { const circle = document.createElement("div"); circle.classList.add("click-effect"); circle.style.left = `${e.pageX}px`; circle.style.top = `${e.pageY}px`; document.body.appendChild(circle); circle.addEventListener("animationend", () => { circle.remove(); }); });
        const body = document.querySelector("body"); audio = new Audio('' + linkmp3.src); tombol = document.querySelector('#Tombol');

        function teksAnimasi(textNim) {
            mainTxt.innerHTML = "";
            new TypeIt(mainTxt, {
                strings: [textNim],
                startDelay: 50, speed: 27, cursor: true, waitUntilVisible: true,
                afterComplete: function () {
                    ...
                    if (currentIndex == 1) { 
                        setTimeout(mulaikemunculan, 800);
                    }
                    if (currentIndex == 2){
                    	fnTimer();
                    }
                    if (currentIndex == 3){
                        ...
                        setTimeout(() => { mainSt.style.transform = 'scale(1)'; }, 400);
                    	setInterval(falling,270);
                    }
                },
            }).go();
        }
        ...
        function henti(){clearInterval(tmer)}
        ...
        function mulaihitung(){
            ...
            setTimeout(()=> {
                ...
                setTimeout(()=>{
                    document.querySelector('.txtWaktu').innerHTML = "<span style='font-size:18px;font-weight:700'><br><br></span>Ehh, canda canda 😝";
                    setTimeout(()=>{document.querySelector('.txtWaktu').style="opacity:1";setTimeout(nextSection, 1500);}, 200);
                }, 800);
            }, 2000);
        }

        function mulaikemunculan(){
            document.querySelector('.txtKemunculan').innerHTML = "<span style='font-size:18px;font-weight:700'><br><br></span>Balikan yukkk 🫠";
            setTimeout(()=>{
                document.querySelector('.txtKemunculan').style="opacity:1";
                
                // setTimeout(nextSection, 3000);
                setTimeout(()=>{
                     tombol.style = "position:relative;transform:scale(1);opacity:1";
                },500);
            }, 200);
        }
        ...
        document.getElementById("loveIn").onclick = function () {
            if (sudahKlik) {
                ...
                setTimeout(function () {
                    ...
                    setTimeout(() => { teksAnimasi(texts[currentIndex]) }, 300);
		...
		function fungsibaru(btn) {
		    ...
		    if (jumlahKlik == 4) {fungsiGamau();jumlahKlik = 0;}
        ...
        function fungsiGamau() {
            Swal.fire({
                title: '' + teksGamau.innerHTML,
                imageUrl: '' + stikerGamau.src,
                imageWidth: 90,
                imageHeight: 90,
