...
//   vketik2=pesan2.innerHTML;
  ...
  //wallpaper.style="transform: scale(1.5);";
  new TypeIt("#kalimat", {
  strings: ["" + vketik3], startDelay: 1, speed: 30, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    kalimat.innerHTML=vketik3;
    setTimeout(aktipesan4,800);
  },}).go();
  }
  ...
  new TypeIt("#pesan4", {
  strings: ["" + vketik4], startDelay: 1, speed: 33, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  fthilang();ftganti=2;setTimeout(ftmuncul,300);
  new TypeIt("#pesan5", {
  strings: ["" + vketik5], startDelay: 1, speed: 33, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    pesan5.innerHTML=vketik5;
    setTimeout(aktipesan6,1300);
  },}).go();
  }
  ...
  new TypeIt("#pesan6", {
  strings: ["" + vketik6], startDelay: 1, speed: 33, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  function checkslov() {if(slov==4){kolombaru.style="position:relative;transform:scale(1)";fthilang();ftganti=1;setTimeout(ftmuncul,300);otomatis();setTimeout(()=>{kolombaru.style="";kalimat.innerHTML="";},400);setTimeout(aktipesan3,600);}}
