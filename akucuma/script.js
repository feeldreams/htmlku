...
*/
  ...
  function AnimasiTeks(){
  	stikersec2.style="margin-top:-100px;margin-bottom:0;transform:scale(.9);transition:all .7s ease";
  	scrollContainer.style="transform: scale(1)";
  	new TypeIt("#textsec2", {
      strings: ["" + ID_AnimasiTeks], startDelay: 100, speed: 40, /* deff 55 */ cursor: true,
  ...
  function AnimasiTeks2(){
      ...
      afterComplete: function(){
          ...
          stikersec2.style="margin-top:-100px;margin-bottom:0;transform:scale(0);transition:all .7s ease";
          setTimeout(function() {
              stikersec2.style = "margin-top:-100px;margin-bottom:0;transform:scale(.9);transition:all .7s ease";
...
document.getElementById("loveIn").onclick = function() {
    ...
    overlay.style.display = "none";
    //initom.style="";
    first_stiker.style="transform: scale(1);margin-top:-50px";
    /*setTimeout(function() {
