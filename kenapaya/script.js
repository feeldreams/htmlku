...
*/
  ...
  function mulaitextseco(){
  	stikersec4.style="margin-top:-50px;margin-bottom:0;transform:scale(.9);transition:all .7s ease";
      ...
      afterComplete: function(){
          ...
          stikersec4.style="margin-top:-50px;margin-bottom:0;transform:scale(0);transition:all .7s ease";
          setTimeout(function() {
              stikersec4.style = "margin-top:-50px;margin-bottom:0;transform:scale(.9);transition:all .7s ease";
...
function tes(){
  ...
  setTimeout(function(){
  	if(skrg<4){sentuh.style="margin-top:100px;transform:scale(1)";}
  }, 500);
  setTimeout(function() {
        if(fungsi==0){
           ...
           fungsi = 1;
           setTimeout(function(){fungsi=0}, 500);
           skrg++;
           if(skrg==2){
           	stikersec2.style="transform:scale(0);transition:all .7s ease";
          setTimeout(function() {
              stikersec2.style = "transform:scale(1);transition:all .7s ease";
          }, 500);
           }
           
           if(skrg==3){
           	stikersec3.style="transform:scale(0);transition:all .7s ease";
          setTimeout(function() {
              stikersec3.style = "transform:scale(1);transition:all .7s ease";
          }, 500);
           }
           if(skrg==4){sentuh.style="margin-top:100px;transform:scale(0);opacity:0";fungsi=0;setTimeout(mulaitextseco,800);setTimeout(function() {stikersec4.style="transform:scale(1);transition:all .7s ease";}, 500);}
        }
  }, 100);
}
