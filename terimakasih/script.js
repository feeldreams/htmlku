...
document.getElementById("loveIn").onclick = function() {
      if(fungsiAwal==0){
        ...
        ftoAwal.style="transition:all .8s ease;transform:scale(0);border-radius: 50%;";
  ...
  function kalimatakhir(){
      ...
      afterComplete: function(){
         ...
         if(pesanAkhir1==inip[totalPesan+1]){
            ...
            ftAwal.style="transform: scale(.7);transition: all .8s ease;";
            ftoAwal.style="transform: scale(1);transition: all .8s ease;box-shadow: 0 4px 30px rgba(255,255,255, 0.3);backdrop-filter: blur(5px);-webkit-backdrop-filter: blur(5px);background: rgba(255, 255, 255, 0.7);border: 1px solid rgba(255, 255, 255, 0.3);border-radius: 50%;padding:10px;";
